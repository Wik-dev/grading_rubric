        ...
        _write_artifact_json(
            artifact_dir / "run_metadata.json",
            {
                ...
                "settings": {
                    ...
                    "simulation_target_responses": settings.simulation_target_responses,
                    "simulation_panel_size": settings.simulation_panel_size,
                    "simulation_pairwise_pairs": settings.simulation_pairwise_pairs,
                    "simulation_concurrency": settings.simulation_concurrency,
